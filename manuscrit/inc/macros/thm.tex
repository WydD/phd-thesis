...
% #3 = style (S - M)
\def\newthmtype#1#2#3{
        \DeclareCaptionFormat*{#1label}{\hspace{2em}{\ifx#3S\it\else\bf\fi ##1}\hfill \phantom{p}  {\bf ##3}}\floatstyle{plaintop}
  ...
  \caption{##1}\vspace{-0.7em}\raggedleft%
		...
		{\par\phantom{m} \end{minipage}%
                    \end{lrbox}%
                    \noindent\fcolorbox{black}{#1color}{\usebox{\BODY}\hspace{1em}}%
                \end{#1float}}
}
