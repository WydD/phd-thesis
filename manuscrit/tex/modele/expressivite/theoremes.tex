...
Le corrolaire~\ref{cor:equivalence-winstr} à ce théorème permet d'interpréter $\IS$ comme l'opération inverse de la fenêtre \enquote{dernier batch} $[B]$, entre autres.
