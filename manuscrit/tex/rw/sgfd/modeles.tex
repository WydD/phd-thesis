...
\item Ensuite un opérateur d'agrégation $AVG_{temp}$\footnote{notation simplifiée de l'opérateur d'agrégation sans groupement dont le résultat est une relation avec un seul attribut \textit{avg}}. Nous obtenons ainsi une relation avec un seul n-uplet.
